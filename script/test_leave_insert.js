(async () => {
  try {
    ...
    const payload = {
      ...
      end_date: '2026-01-16',
      reason: 'script test leave',
      attachment: null
    };

    console.log('Attempting leave insert:', payload);
    const res = await fetch(`${SUPA}/rest/v1/leaves`, { method: 'POST', headers: { ...headers, Prefer: 'return=representation' }, body: JSON.stringify(payload) });
